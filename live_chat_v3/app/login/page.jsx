                ...
                <div class="display">
                    <div class="artboard artboard-demo phone-1">
                        ...
                        <div className="tabs tabs-boxed">
                            <a className="tab tab-boxed" href="/signup">Sign Up</a>
                            <a className="tab tab-active">Log In</a>
                        </div>
                        <form action="" className="w-full">
                            ...
                            <button type="submit" className="btn btn-circle w-2/3 mt-4 mx-auto block">Log In</button>
                        </form>
                    </div>
                </div>
            </div>
